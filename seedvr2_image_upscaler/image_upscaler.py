...
class SeedVR2ImageUpscaler(io.ComfyNode):
        ...
        return io.Schema(
            ...
            inputs=[
                ...
                io.Combo.Input("offload_device",
                    options=SeedVR2ImageUpscaler._get_offload_device_options(include_none=True, include_cpu=True),
                    default="cpu",
                    optional=True,
                    tooltip=(
    ...
    def execute(
        ...
        try:
            ...
            resolved_tile_upscale_resolution = self._resolve_tile_upscale_resolution(
    ...
    def _resolve_tile_upscale_resolution(self, tile_upscale_resolution: int, tile_size: int, upscale_factor: float) -> int:
        min_resolution = 64
        max_resolution = 8192
        step = 8
